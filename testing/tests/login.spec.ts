...
test.afterEach( async ({ page }, testInfo) => {
    ...
    test("Login Extitoso", async ({ page }) => {
        await test.step('Navigate to the website',async function() {
            
        })
        await test.step('Enter the username ',async function() {
            
        })
        await test.step('Enter the password and press the Enter key',async function() {
